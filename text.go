...
import (
	...
	"github.com/QObounou/Projet-forum"
)

type Like struct {
	ID        uint64    `forum:"primary_key;auto_increment" Qobounou:"id"`
	UserID    uint32    `forum:"not null" json:"user_id"`
	PostID    uint64    `forum:"not null" json:"post_id"`
	CreatedAt time.Time `forum:"default:CURRENT_TIMESTAMP" Qobounou:"created_at"`
	UpdatedAt time.Time `forum:"default:CURRENT_TIMESTAMP" Qobounou:"updated_at"`
}
